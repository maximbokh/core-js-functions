...
function getPowerFunction(exponent) {
  const numOne = exponent;

  return (numTwo) => numTwo ** numOne;
}
...
function logger(func, logFunc) {
  ...
  return (...args) => {
    ...
    const startText = `${name}(${argsText}) starts`;
    const endsText = `${name}(${argsText}) ends`;
